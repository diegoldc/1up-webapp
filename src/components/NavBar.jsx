...
function NavBar() {
  ...
  return (
    ...
    <nav className={`navBar ${isNavOpen && "open"} `} >
      ...
      <Link to="https://github.com/diegoldc/1up-webapp" className="navButton gitHubBtn"><img src={github} alt="" /><span className="navLegend">Web app repo</span></Link> 
      <Link to="https://github.com/diegoldc/json-server" className="navButton gitHubBtn"><img src={github} alt="" /><span className="navLegend">Server repo</span></Link>
